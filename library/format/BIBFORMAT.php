...
class BIBFORMAT
{
	private $replaceBibtex = array();
	private $matchBibtex = array();
	...
	function __construct()
	{
		...
		{
			$this->replaceBibtex[] = mb_convert_encoding(chr($key), 'UTF-8', mb_list_encodings());
 ...
 */
	function convertBibtexToUtf8($latex)
	{
		...
		if (mb_detect_encoding($latex, 'UTF-8, ISO-8859-1') == 'ISO-8859-1')
			$latex = mb_convert_encoding($latex, 'UTF-8', mb_list_encodings());
